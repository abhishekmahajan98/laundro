...
import 'package:laundro/components/shop_box.dart';
...
class ShopSelectPage extends StatefulWidget {
  @override
  _ShopSelectPageState createState() => _ShopSelectPageState();
}

class _ShopSelectPageState extends State<ShopSelectPage> {
  final _auth = FirebaseAuth.instance;
  final GoogleSignIn googleSignIn = GoogleSignIn();
  SharedPreferences prefs;
  bool showSpinner = true;
  List<ShopBox> shopsList = [];
