...
class _DryCleaningTileState extends State<DryCleaningTile> {
  void addDryCleaningQty(int index){
    setState(() {
      ...
      Database.dryCleaningDataItems[index]['total_item_cost']+=Database.dryCleaningDataItems[index]['price'];
    });
    ...
    return SingleChildScrollView(
      child: Column(children: <Widget>[
        ListTile(
          ...
          subtitle: Text("₹ " + Database.dryCleaningDataItems[widget.index]['price'].toString()),
          ...
          trailing: SizedBox(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  Text(
                    Database.dryCleaningDataItems[widget.index]['qty'].toString()
                  ),
                  IconButton(
                    icon: Icon(
                      Icons.add
